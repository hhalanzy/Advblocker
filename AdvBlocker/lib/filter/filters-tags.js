 ...
 * Filter tags service
 */
advblocker.tags = (function (advblocker) {
    'use strict';
    ...
    const getTags = function () {
        return advblocker.subscriptions.getTags();
    };

    const getFilters = function () {
        return advblocker.subscriptions.getFilters()
            .filter(f => f.filterId !== advblocker.utils.filters.SEARCH_AND_SELF_PROMO_FILTER_ID);
    };
