...
(function (advblocker, api) {
     ...
     * http://advblocker.com/en/filterrules.html#cssInjection
     */
    var CssFilterRule = (function () {
        ...
        var parsePseudoClass = function (selector) {
            ...
            var nameEndIndex = advblocker.utils.strings.indexOfAny(selector, [' ', '\t', '>', '(', '[', '.', '#', ':', '+', '~', '"', "'"], nameStartIndex + 1);
            if (nameEndIndex < 0) {
        ...
        var constructor = function (rule, filterId) {
            ...
            if (!isInjectRule) {
                ...
                // https://github.com/advblockerTeam/advblockerForAndroid/issues/701
            ...
            if (isInjectRule) {
                ...
                // https://github.com/advblockerTeam/advblockerBrowserExtension/issues/1196
