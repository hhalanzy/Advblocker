    ...
    DomainsLookupTable.prototype = {
        ...
        removeRule: function (rule) {
            ...
            for (var i = 0; i < permittedDomains.length; i++) {
                ...
                var rules = this.lookupTable[domainName];
                if (rules) {
                    advblocker.utils.collections.removeRule(rules, rule);
                    if (rules.length === 0) {
        ...
        getRules: function () {
            ...
            for (var r in this.lookupTable) { // jshint ignore:line
                ...
                if (value) {
                    if (advblocker.utils.collections.isArray(value)) {
            ...
            return advblocker.utils.collections.removeDuplicates(result);
        }
    };
