...
(function (advblocker, api) {
     ...
     * ABP element hiding rules: http://advblocker.com/en/filterrules.html#hideRules
     * CSS injection rules: http://advblocker.com/en/filterrules.html#cssInjection
     */
    ...
    CssFilter.prototype = {
         ...
         * http://advblocker.com/en/filterrules.html#hideRulesExceptions
         * http://advblocker.com/en/filterrules.html#cssInjectionExceptions
         * @private
         */
        ...
        /**
         * Patch rule selector adding advblocker mark and rule info in the content attribute
         * Example:
         * .selector { color: red } -> .selector { color: red, content: 'advblocker{filterId};{ruleText} !important;}
         * @param rule
         * @returns {String}
         */
        _addMarkerToInjectRule: function (rule) {
            var INJECT_HIT_START = " content: 'advblocker";
            ...
            // check semicolon
            var ruleTextWithSemicolon = advblocker.utils.strings.endsWith(ruleTextWithoutCloseBrace, ';') ?
        ...
        /**
         * Patch rule selector adding advblocker mark rule info in the content attribute
         * Example:
         * .selector -> .selector { content: 'advblocker{filterId};{ruleText} !important;}
         * @param rule
         * @returns {String}
         */
        _addMarkerToElemhideRule: function (rule) {
            var ELEMHIDE_HIT_START = " { display: none!important; content: 'advblocker";
            var HIT_SEP = encodeURIComponent(';');
            var HIT_END = "' !important;}\r\n";
