...
PopupController.prototype = {
    ...
    _renderNotificationBlock: function (container, tabInfo, options) {
        ...
        if (!options.notification || tabInfo.advblockerDetected) {
            return;
        }
    ...
    _renderMain: function (container, tabInfo) {
        ...
        if (tabInfo.advblockerDetected) {
            ...
            if (tabInfo.advblockerProductName && tabInfo.advblockerProductName.toLowerCase().includes('mac')) {
                headTitleElement.innerHTML = i18n.getMessage('popup_integrate_mode_title_mac');
            } else if (tabInfo.advblockerProductName && tabInfo.advblockerProductName.toLowerCase().includes('win')) {
    ...
    _renderFooter: function (footerContainer, tabInfo, options) {
        if (tabInfo.advblockerDetected) {
            ...
            if (footerDefaultTitle) {
                footerDefaultTitle.setAttribute('title', i18n.getMessage('popup_advblocker_footer_title'));
            }
            ...
            // if (!options.isDisableShowadvblockerPromoInfo) {
...
(function () {
     ...
     * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/551
    ...
    controller.afterRender = function () {
        ...
        // https://github.com/advblockerTeam/advblockerBrowserExtension/issues/505
        var timeout = 10;
        setTimeout(function () {
