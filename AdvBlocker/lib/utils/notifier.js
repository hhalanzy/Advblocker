...
advblocker.listeners = (function () {
    ...
    var EventNotifier = {
        ...
        notifyListeners: function () {
            ...
            for (var listenerId in this.listenersMap) { // jshint ignore:line
                ...
                try {
                    ...
                    advblocker.console.error("Error invoking listener for {0} cause: {1}", event, ex);
                }
            }
        },
         ...
         * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/251
         */
