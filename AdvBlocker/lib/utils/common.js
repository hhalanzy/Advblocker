 ...
 */
advblocker.BACKGROUND_TAB_ID = -1;

/**
 * Main frame id is equal to 0
 */
advblocker.MAIN_FRAME_ID = 0;

/**
 * Utilities namespace
 */
advblocker.utils = (function () {
...
(function (api) {
    ...
    var StringUtils = {
        ...
        splitByDelimiterWithEscapeCharacter: function (str, delimiter, escapeCharacter, preserveAllTokens) {
            ...
            if (advblocker.utils.strings.isEmpty(str)) {
                return parts;
            }
 ...
 */
advblocker.unload = (function (advblocker) {

    'use strict';

    var unloadChannel = advblocker.utils.channels.newChannel();
 ...
 */
advblocker.utils.RingBuffer = function (size) { // jshint ignore:line
