...
const CssHitsCounter = (function () {
    ...
    /**
     * In order to find elements hidden by advblocker we look for a `:content` pseudo-class
     * with values starting with this prefix. Filter information will be
     * encoded in this value as well.
     */
    const CONTENT_ATTR_PREFIX = 'advblocker';
    ...
    const parseInfo = (content) => {
        ...
        // Attribute 'content' in css looks like: {content: 'advblocker{filterId};{ruleText}'}
    ...
    /**
     * Function checks if elements style content attribute contains data injected with advblocker
     * @param {Node} element
     ...
     * attribute and if it contains 'advblocker'
    ...
    function countCssHitsForMutations() {
        ...
        observer = new MutationObserver(((mutationRecords) => {
            ...
            if (allProbeElements.length > 0) {
                 ...
                 * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/1096
                 */
    ...
    const init = function (callback) {
        if (typeof callback !== 'function') {
            throw new Error('advblocker Extension: "callback" parameter is not a function');
        }
