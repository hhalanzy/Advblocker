 ...
 * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/892
 */
advblocker.rulesStorageImpl = (function (advblocker, initialAPI) {

    var STORAGE_NAME = 'advblockerRulesStorage';

    var database;

    function onError(error) {
        advblocker.console.error('advblocker rulesStorage error: {0}', error.error || error);
    }
