 ...
 *
 * This API is exposed via advblocker.utils.cookie:
 *
...
(function (advblocker) {
    ...
    function parseCookie(cookieValue) {
        if (advblocker.utils.strings.isEmpty(cookieValue)) {
            return null;
        }
    ...
    function parseSetCookie(setCookieValue) {
        if (advblocker.utils.strings.isEmpty(setCookieValue)) {
            return null;
        }

        const parts = setCookieValue.split(";").filter(s => !advblocker.utils.strings.isEmpty(s));
    ...
    function serialize(cookie) {
        ...
        if (!advblocker.utils.strings.isEmpty(cookie.sameSite)) {
