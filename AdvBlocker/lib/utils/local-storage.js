 ...
 */
advblocker.localStorageImpl = (function () {

    var advblocker_SETTINGS_PROP = 'advblocker-settings';
    var values = null;

    function checkError(ex) {
        if (ex) {
            advblocker.console.error('{0}', ex);
        }
    }
     ...
     * Part of task https://github.com/advblockerTeam/advblockerBrowserExtension/issues/681
    ...
    var setItem = function (key, value) {
        ...
        values[key] = value;
        write(advblocker_SETTINGS_PROP, values, checkError);
    };
     ...
     * localStorage is affected by cleaning tools: https://github.com/advblockerTeam/advblockerBrowserExtension/issues/681
    ...
    var init = function (callback) {
        ...
        read(advblocker_SETTINGS_PROP, function (ex, items) {
            if (ex) {
                checkError(ex);
            }
