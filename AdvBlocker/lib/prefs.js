 ...
 */
advblocker.prefs = (function (advblocker) {

    var Prefs = {

        get mobile() {
            return advblocker.lazyGet(Prefs, 'mobile', () => {
        ...
        get browser() {
            return advblocker.lazyGet(Prefs, 'browser', function () {
                var browser;
        ...
        get chromeVersion() {
            return advblocker.lazyGet(Prefs, 'chromeVersion', function () {
        ...
        get firefoxVersion() {
            return advblocker.lazyGet(Prefs, 'firefoxVersion', () => {
         ...
         */
        get edgeVersion() {
            return advblocker.lazyGet(Prefs, 'edgeVersion', function () {
        ...
        get ICONS() {
            return advblocker.lazyGet(Prefs, 'ICONS', function () {
                return {
                    ICON_BLUE: {
                        '19': advblocker.getURL('icons/blue-19.png'),
                        '38': advblocker.getURL('icons/blue-38.png')
                    },
                    ICON_GREEN: {
                        '19': advblocker.getURL('icons/green-19.png'),
                        '38': advblocker.getURL('icons/green-38.png')
                    },
                    ICON_GRAY: {
                        '19': advblocker.getURL('icons/gray-19.png'),
                        '38': advblocker.getURL('icons/gray-38.png')
                    }
                };
            });
        },
        ...
        // https://github.com/advblockerTeam/advblockerBrowserExtension/issues/1006
