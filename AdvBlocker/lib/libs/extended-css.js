...
* https://github.com/advblockerTeam/ExtendedCss
 ...
 * https://github.com/advblockerTeam/FingerprintingBlocker/blob/master/src/shared/url.ts#L64
 */
...
var ExtendedCssParser = function () {
    ...
    /**
     * Regex that matches advblocker's backward compatible syntaxes.
     */
...
/*!
 * Sizzle CSS Selector Engine v2.3.4-pre-advblocker
 * https://sizzlejs.com/
 *
 ...
 */
/**
 * Version of Sizzle patched by advblocker in order to be used in the ExtendedCss module.
 * https://github.com/advblockerTeam/sizzle-extcss
 * 
 * Look for [advblocker Patch] and advblocker_EXTCSS markers to find out what exactly was changed by us.
 * 
 * Global changes:
 ...
 * 
 * Changes that are applied to the advblocker_EXTCSS build only:
 ...
 * In the case of advblocker ExtendedCss we want to avoid initializing Sizzle right away
...
var initializeSizzle = function () {
						...
						if (support.qsa && !nonnativeSelectorCache[selector + " "] && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
							...
							if (newSelector) {
								try {
									...
									// [advblocker Path]: Fix the cache value
    ...
    * https://github.com/advblockerTeam/ExtendedCss/issues/55#issuecomment-364058745
    */
    ...
    */
      ...
      */
				...
				/** [advblocker Patch]: Sorting tokens */
				var sortedGroups = sortTokenGroups(groups);

				/** [advblocker Patch]: Change the way tokens are cached */
				var tokensCacheItem = {
					groups: groups,
    ...
    */
			...
			// Do not expose Sizzle to the global scope in the case of advblocker ExtendedCss build
...
var StyleObserver = function () {
     ...
     * This field is essential in the case of advblocker products that add regular stylesheets
 ...
 * https://github.com/advblockerTeam/ExtendedCss/blob/master/README.md
 */
...
var ExtendedSelectorFactory = function () {
    ...
    function ExtendedSelectorParser(selectorText, tokens, debug) {
        ...
        if (typeof tokens === 'undefined') {
            ...
            // In Sizzle internally, the tokens are re-sorted: https://github.com/advblockerTeam/ExtendedCss/issues/55
...
function ExtendedCss(configuration) {
    ...
    function applyRules() {
        ...
        // https://github.com/advblockerTeam/ExtendedCss/issues/81
        stopObserve();
