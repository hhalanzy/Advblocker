...
ace.define("ace/mode/advblocker_highlight_rules",[], function (require, exports, module) {
  'use strict';
  ...
  var advblockerHighlightRules = function () {
    this.$rules = {
      "start": [
        {
          include: "comments"
  ...
  advblockerHighlightRules.metaData = {
    '$schema': 'https://raw.githubusercontent.com/martinring/tmlanguage/master/tmlanguage.json',
    name: 'Adblock',
    scopeName: 'text.adblock',
  };

  oop.inherits(advblockerHighlightRules, TextHighlightRules);
  exports.advblockerHighlightRules = advblockerHighlightRules;
});
...
ace.define("ace/mode/advblocker",[], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var advblockerHighlightRules = require("./advblocker_highlight_rules").advblockerHighlightRules;
var FoldMode = require("./folding/cstyle").FoldMode;

var Mode = function() {
    this.HighlightRules = advblockerHighlightRules;
    this.foldingRules = new FoldMode();
};
oop.inherits(Mode, TextMode);

(function() {
    this.$id = "ace/mode/advblocker"
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    ace.require(["ace/mode/advblocker"], function(m) {
