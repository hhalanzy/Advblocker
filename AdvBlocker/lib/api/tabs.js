 ...
 */
advblocker.windowsImpl = (function (advblocker) {
    ...
    var forEachNative = function (callback) {
        ...
        // https://github.com/advblockerTeam/advblockerBrowserExtension/issues/569
    ...
    return {
        ...
        onCreated: onCreatedChannel, // callback (advblockerWin, nativeWin)
 ...
 */
advblocker.tabsImpl = (function (advblocker) {
    ...
    function checkLastError(operation) {
        ...
        if (ex) {
            advblocker.console.error("Error while executing operation{1}: {0}", ex, operation ? " '" + operation + "'" : '');
        }
        return ex;
    }
    ...
    function focusWindow(tabId, windowId, callback) {
         ...
         * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/675
         */
    ...
    var create = function (createData, callback) {
        ...
        if (createData.type === 'popup' &&
            ...
            !advblocker.utils.browser.isEdgeBeforeCreatorsUpdate() &&
            // Isn't supported by Android WebExt
            !advblocker.prefs.mobile) {
            // https://developer.chrome.com/extensions/windows#method-create
            // https://developer.mozilla.org/en-US/Add-ons/WebExtensions/API/windows/create
        ...
        function onWindowFound(win) {
            ...
            browser.tabs.create({
                 ...
                 */
                windowId: !advblocker.prefs.mobile ? win.id : undefined,
                url: url,
                active: active,
            }, function (chromeTab) {
                if (active) {
    ...
    var reload = function (tabId, url) {
        if (url) {
            if (advblocker.utils.browser.isEdgeBrowser()) {
                /**
                 ...
                 * https://github.com/advblockerTeam/advblockerBrowserExtension/issues/580
                 */
                setTimeout(function () {
     ...
     */
    const userCSSSupport = advblocker.prefs.features.userCSSSupport;
