...
(function (api, advblocker) { // jshint ignore:line
    ...
    function clearAccessToken() {
        ...
        advblocker.listeners.notifyListeners(advblocker.listeners.SYNC_BAD_OR_EXPIRED_TOKEN, DROPBOX_PROVIDER_NAME);
    }
    ...
    function callListFolderLongPoll() {
        ...
        if (!dropboxFolderState.longPollingEnabled) {
            advblocker.console.info('{0} long polling is disabled', DROPBOX_PROVIDER_NAME);
            return;
        }
        ...
        syncListFiles()
            ...
            .catch(function (error) {
                advblocker.console.error('Dropbox sync error {0}', error);
    ...
    var load = function (name, callback) {
        ...
        isFileExists(name)
            ...
            .catch(function (error) {
                ...
                advblocker.console.error('Dropbox sync error {0} {1}', name, error);
                callback(false);
            });
    };
    ...
    var init = function () {
        advblocker.console.info('Initialize {0} sync provider', DROPBOX_PROVIDER_NAME);
    ...
    var shutdown = function () {
        advblocker.console.info('Shutdown {0} sync provider', DROPBOX_PROVIDER_NAME);
        dropboxFolderState.forceSync = true;
    ...
    api.syncProviders.register(DROPBOX_PROVIDER_NAME, {
        ...
        title: advblocker.i18n.getMessage("sync_provider_dropbox"),
        // Storage api
        load: load,
        save: save,
        init: init,
